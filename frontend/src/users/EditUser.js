...
export default function EdidtUser() {
  ...
  const loadUsers = async () => {
    const result = await axios.get(`http://localhost:8888/students/id/${id}`);
    console.log(result);
  ...
  const onSubmit = async (e) => {
    e.preventDefault();
    await axios.put(`http://localhost:8888/students/update/${id}`, user);
    navigate("/home");
    console.log(user);
  };
